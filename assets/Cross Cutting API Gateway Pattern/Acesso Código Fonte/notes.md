Seguem em anexo abaixo os arquivos contendo os códigos fontes dos microservices Api-Gateway, Authuser e Course referente ao que foi construído no presente módulo Cross Cutting API Gateway Pattern. 
